...
//        giveMassOfMolecule(molecule: "(CH2)C(H2)4")
//        giveMassOfMolecule(molecule: "(C2H2)(CH)3CH")
    ...
    //    }
        ...
        for (multiplyer , numberOfParenetecie) in emptyArray {
...
//        var iterationHere = 0
//
//        for (chemicalElement , numberOfParenetecie) in stringsInParenatacies {
//         iterationHere = iterationHere + 1
//            if emptyArray[iterationHere - 1].1 == iterationHere {
//                massOfParentaciesWithoutAddingAndMultiplayerForThem.append((mendeleevChart[chemicalElement]! * 2 , Int(numberOfParenetecie)!))
//            }else{
//
//                massOfParentaciesWithoutAddingAndMultiplayerForThem.append((mendeleevChart[chemicalElement]! , Int(numberOfParenetecie)!))
//            }
//
//            print("number of parentecie is \(numberOfParenetecie) and mass is \(chemicalElement) \(mendeleevChart[chemicalElement])")
//
//
//        }
//
