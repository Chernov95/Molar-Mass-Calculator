...
//        print("Number and their indexes are \(numbersAndTheirsIndexes)")
        ...
        //Calculate Percantage and Number of Atoms
//        print("chemicalElementsOutsideOfParentacies are \(chemicalElementsOutsideOfParentacies)")
...
//                        dictionary[chemicalElement] = (mendeleevChart[chemicalElement] , 1) as! (massOfChemicelElement: Double, numberOfAtoms: Int)
    ...
    print("Is this dictionary is set properly ? \(dictinaryWhichHaveInformationAboutAtomsInParentaciesToShowPercentage)")
        //Fe(OH2)3(O2HO)Mn2Fe2HH(O2HO2)2H
...
//        dictionaryToShowPercantageOfEveryAtom =   dictionaryToShowPercantageOfEveryAtom.sorted {$0.value.massOfChemicelElement < $1.value.massOfChemicelElement }
        _ = dictionaryToShowPercantageOfEveryAtom.sorted(by: {$0.value.massOfChemicelElement < $1.value.massOfChemicelElement})
//        dictionaryToShowPercantageOfEveryAtom.
